  ...
  return (
    <div className="flex flex-col gap-6 max-w-5xl mx-auto pb-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <MetricTile
          title="Voice calls"
          value={data.voiceCalls}
          sub={`${data.voiceCompleted} completed`}
          icon={Phone}
          color="var(--chart-violet)"
          index={5}
        />
        <MetricTile
          ...
          sub={`${data.humanHandoffs} handoffs`}
          icon={Flame}
          color="var(--chart-rose)"
          index={6}
        />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <Card
          className="glass-card lg:col-span-2 animate-slide-in-up"
        ...
        {/* Quality Signals */}
        <Card
          className="glass-card lg:col-span-1 animate-slide-in-up"
        ...
        >
          ...
          <CardContent className="p-6 flex flex-col gap-8">
            ...
            <div className="p-3 rounded-lg bg-muted/50 text-[11px] text-muted-foreground text-center border border-border/50">
              Reply-rate, open-rate, and per-sequence-step funnels land in v1.1
              with the Gmail send integration.
            </div>
          </CardContent>
        </Card>
      </div>
    ...
    >
      ...
      <CardContent className="p-6 flex flex-col relative z-10">
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="w-8 h-8 rounded-lg flex items-center justify-center bg-background/50 border border-border/50 shadow-sm">

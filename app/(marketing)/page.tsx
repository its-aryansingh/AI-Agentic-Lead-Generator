    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 text-center gap-8 py-20 max-w-4xl mx-auto">
        <Badge variant="secondary">
          Autonomous B2B Sales Outreach · 25 Free Credits · India + Global
        </Badge>

        <h1 className="text-4xl md:text-5xl font-semibold tracking-tight leading-tight max-w-2xl">
          Autonomous AI sales outreach that actually sounds like you wrote it
        </h1>

        <p className="text-muted-foreground max-w-xl text-lg">
          Describe your ideal customer in plain English. Aravya SalesEngAI
          discovers matching prospects, drafts personalized emails, qualifies
          replies, executes voice follow-ups, and syncs to your CRM.
        </p>
